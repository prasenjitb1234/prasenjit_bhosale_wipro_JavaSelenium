...
public class Ebay_Login {
	...
	public void addToCartAndRemove() throws InterruptedException {
		...
		WebElement removeButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button[data-test-id='cart-remove-item']")));
...
//	----
	...
	public void changeCurrentAddress() throws InterruptedException {
		...
		// street address
		WebElement streetAddress = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("input[aria-label='Street address']")));
		streetAddress.clear();
